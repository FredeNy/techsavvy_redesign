//Ugens startup artikler komponent
"use client";
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      ...
      try {
        ...
        // Filtrer artikler efter kategori og vælg de første 3
...
console.log(articles);
  ...
  return (
    <section className="bg-Navyblue text-White">
      <h2 className="font-openSans text-xl md:text-2xl font-bold pt-6 pl-4 md:pl-6">UGENS STARTUP</h2>
